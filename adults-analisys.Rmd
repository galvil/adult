...
Una vegada comprovada la normalitat, utilitzarem el test de Fligner-Killeen per comprovar la homogeneïtat de les variances mitjançant la mitjana. Comprovem la homogeneïtat de capital-gain amb el sexe.
...
qqnorm(dadesAdult$`capital-gain`, pch = 19, col = "gray50")
qqline(dadesAdult$`capital-gain`)
```
